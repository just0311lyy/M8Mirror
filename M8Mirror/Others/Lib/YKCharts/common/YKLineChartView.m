...
//    double  yEachValue = 30/(_numberOfYLines - 1);
...
//        }
        [line setYValue:[NSString stringWithFormat:@"%.0f",yValue] suffix:_dataSource.ySuffix withUIConfgi:_uiConfig];
