...
-(void)layoutSubviews{
    ...
    _LeftTitleLabel.frame = CGRectMake(10, offsetY, 100, _LeftTitleLabel.font.lineHeight);
//    [_LeftTitleLabel setTextAlignment:NSTextAlignmentRight];
...
//    NSString *stringTotal = [NSString stringWithFormat:@"%@ %@",yValue,suffix];
    NSString *stringTotal = [NSString stringWithFormat:@"%@",yValue];
