...
//    _selTable.layer.borderColor=[].CGColor;
//    _selTable.layer.borderWidth = 1.0;
    _selTable.backgroundColor = UIColorFromRGB(0x5f6061);
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.selectBtn.frame = CGRectMake(_selTable.frame.size.width- 50 - 40,(cell.frame.size.height - 40)/2, 40, 40);
