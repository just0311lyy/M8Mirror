//
//  M8CustomerListViewController.m
//  M8Mirror
//
...
@interface M8CustomerListViewController ()<UITableViewDelegate,UITableViewDataSource,UISearchResultsUpdating,M8CustomerEditViewControllerDelegate>
...
@implementation M8CustomerListViewController
...
-(void)initWithListView{
    CGFloat table_Y = 64;
    CGFloat table_H = SCREEN_H - table_Y - 49;
    
    if (!_tableView) {
        _tableView = [[UITableView alloc] initWithFrame:CGRectMake(0, table_Y, SCREEN_W, table_H) style:UITableViewStylePlain];
